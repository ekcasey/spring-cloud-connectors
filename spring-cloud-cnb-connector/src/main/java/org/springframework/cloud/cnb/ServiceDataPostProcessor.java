...
public interface ServiceDataPostProcessor {
	 ...
	 * the environment and transformed from JSON text into a {@link CNBRawServiceData} data structure.
	 *
	 ...
	 * </pre>
	 *
	 * Then the {@link CNBRawServiceData} data structure would contain the equivalent of this:
	 *
	 * <pre>
	 * {@code
	 * {
	 ...
	 */
	CNBRawServiceData process(CNBRawServiceData serviceData);
}
