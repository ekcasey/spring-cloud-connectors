 ...
 */
public abstract class CNBServiceInfoCreator<SI extends ServiceInfo> implements ServiceInfoCreator<SI, Map<String, Object>> {

	private Tags tags;
	private String[] uriSchemes;

	public CNBServiceInfoCreator(Tags tags, String... uriSchemes) {
		this.tags = tags;
